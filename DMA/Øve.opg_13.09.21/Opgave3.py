...
3) 
2-sum og 3-sum. Lad A[0 . . . n − 1] være et array af heltal (positive og negative). 
Tabellen A har en 2-sum, hvis der findes indgange i og j, så A[i] + A[j] = 0. 
Tilsvarende har A en 3-sum, hvis der findes indgange i, j og k, så A[i] + A[j] + A[k] = 0. 
...
f) Giv en algoritme, der afgør om A har en 3-sum i Θ(n2 log n) tid.
g) (***) Giv en algoritme, der afgør om A har en 3-sum i Θ(n2) tid. 